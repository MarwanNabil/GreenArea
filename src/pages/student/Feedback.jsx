    ...
    return (<>
        <div className="bg-footer h-screen">
            ...
            <div className="text-center flex flex-col gap-y-11 mt-12">
                <p className="text-white text-4xl font-bold">Send Feedback</p>
            </div>
            <div className="flex my-12 flex-col items-center w-full">
                <form className="flex flex-col text-xl w-2/5">
                    <textarea
                        type="textarea"
                        required
                        className="pl-12 max-h-52 rounded-md mb-10 h-20 bg-gray"
                    />
                    <div>
                        <Link to={'/studentdashboard'} className="mt-10">
                            <button className="w-full bg-green-700 px-5 py-2 text-lg font-semibold rounded-lg hover:bg-green-600 text-white"> Send Feedback </button>
                        </Link>
                    </div>
                    <Link to={'/studentdashboard'} className="mt-10">
