    ...
    <>
      <div className="counselor-sec h-screen">
        ...
        <div className="flex flex-col items-center">
          ...
          <div>
            <p className="mt-20 text-lg font-semibold font-roboto">
              Name : Ali Mohamed
            </p>
            <p className="mt-5 text-lg font-semibold font-roboto">Age : 32</p>
            <p className="mt-5 text-lg font-semibold font-roboto">
              Email : AliMohamed123@gmail.com
            </p>
            <p className="mt-5 mb-5 text-lg font-semibold font-roboto">
              Score : 85
            </p>
            <Link to={"/studentdashboard"}>
              <button className="w-full text-white text-center bg-footer px-8 py-2 text-base font-medium rounded-lg hover:bg-green-600 hover:text-white">
                Back To Dashboard
              </button>
            </Link>
          </div>
