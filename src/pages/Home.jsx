    ...
    <>
      <div className="bg-img">
        <div className="bg-color flex flex-col items-center">
          ...
          <div className="text-center font-roboto font-semibold text-6xl text-white my-auto">
            ...
            <Link to={"/login"}>
              <button className="w-1/2 text-black bg-white px-3 py-3 text-lg font-semibold rounded-lg hover:bg-green-600 hover:text-white">
                {" "}
                Join Us{" "}
              </button>
            </Link>
      ...
      <section className="p-6 counselor-sec">
        <div className="container my-8">
          <p className="text-center text-2xl text-green-700 font-bold font-roboto my-8 mt-8">
            Expert Counselors
          </p>
          <div className="all-boxes">
            <div className="box p-5 m-4">
              <img src={counselor1} alt="counselor_1" />
              <p className="counselor-dep">CS Counselor</p>
              <p className="counselor-name">Marwan Nabil</p>
              <p>
            ...
            <div className="box p-5 m-4">
              ...
              <p className="counselor-dep">IS Counselor</p>
              <p className="counselor-name">Mohamed Ashraf</p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Architecto, velit.
              </p>
            ...
            <div className="box p-5 m-4">
              ...
              <p className="counselor-dep">IT Counselor</p>
              <p className="counselor-name">Mohamed Hany</p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Architecto, velit.
              </p>
      ...
      <section>
        <div className="container">
          <p className="text-center text-4xl dark-color font-bold font-roboto my-16 mt-12">
            Our Activities
          </p>
          <p className="text-2xl font-bold my-4 mb-8 dark-color">
            You can ask any qeustion you think about and an expert will answer
            you immediately .
          </p>
      ...
      <div className="bg-img-sec flex flex-col items-center justify-center">
        <p className="text-center text-5xl text-white font-bold font-roboto my-10">
          Don't Think, Begin Now
        </p>
        <Link to={"/login"}>
          <button className="mt-4 text-black text-center bg-white px-32 py-4 text-base font-medium rounded-lg hover:bg-green-600 hover:text-white">
            Login
          </button>
        </Link>
      </div>
      <section className="pb-24 counselor-sec">
        <div className="container">
          <p className="text-center text-4xl dark-color font-bold font-roboto py-16 mb-4 pt-12">
            About Us
          </p>
          <div className="flex">
            <p className="text-lg leading-10 font-bold w-2/4 my-10 mr-8 dark-color">
              A comprehensive educational site for all educational levels. Our
              motto is excellence and a better educational future. Our goal is
              to help students succeed and excel, improve their results, and
              develop their level and level of education .
            </p>
            <img
              src={aboutImg}
              className="w-2/4 rounded-xl shadow-2xl drop-shadow-xl"
              alt="aboutImg"
            />
          </div>
        </div>
